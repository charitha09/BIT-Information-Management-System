<%-- 
    Document   : selectSemester6Courses
    Created on : Aug 3, 2016, 10:46:24 PM
    Author     : nadeesh
--%>
...
<html>
    <head>
        ...
        <title>Select Semester 6 Courses</title>
    </head>
    <body>
        <div class="container">
            <div class="col-sm-8">
                <h1>Select Semester 6 Courses</h1>
                ...
                <form action="selectCoursesServlet" method="POST" name="selectSemester6Courses">
                    <table class="table table-striped tbl" border="1" style="width:100%">
                        ...
                        <tr>
                            <td><input type="checkbox" name="check1" value="IT6105"></td>  
                            <td>IT6105</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check2" value="IT6205"></td>  
                            <td>IT6205</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check3" value="IT6305"></td>  
                            <td>IT6305</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check4" value="IT6405"></td>  
                            <td>IT6405</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check5" value="IT6505"></td>  
                            <td>IT6505</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check6" value="IT6605"></td>  
                            <td>IT6605</td>
                            <td>Industrial Placement</td>
                            <td>Compulsory</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check7" value="EN6101"></td>  
                            <td>EN6101</td>
                            <td>Introduction to Entrepreneurship</td>
                            <td>Compulsory</td>
                            <td><input type="radio" name="7" value="M001"></td>
                            <td><input type="radio" name="7" value="M002"></td>
                            <!--<td><input type="radio" name="7" value="M003"></td>-->
                            <td>1=>
                                <input type="radio" name="7" value="I001">2=> 
                                <input type="radio" name="7" value="I002">3=> 
                                <input type="radio" name="7" value="I003">4=> 
                                <input type="radio" name="7" value="I004">5=> 
                                <input type="radio" name="7" value="I005">6=> 
                                <input type="radio" name="7" value="I006"> 
                            </td>
                        </tr>
                    </table>

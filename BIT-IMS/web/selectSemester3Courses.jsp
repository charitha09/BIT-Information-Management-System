<%-- 
    Document   : selectSemester3Courses
    Created on : Aug 3, 2016, 10:45:51 PM
    Author     : nadeesh
--%>
...
<html>
    <head>
        ...
        <title>Select Semester 3 Courses</title>
    </head>
    <body>
        <div class="container">
            <div class="col-sm-8"> 
                <h1>Select Semester 3 Courses</h1>
                ...
                <form action="selectCoursesServlet" method="POST" name="selectSemester3Courses">
                    <table class="table table-striped tbl" border="1" style="width:100%">
                        ...
                        <tr>
                            <td><input type="checkbox" name="check1" value="IT3105"></td>  
                            <td>IT3105</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check2" value="IT3205"></td>  
                            <td>IT3205</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check3" value="IT3305"></td>  
                            <td>IT3305</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check4" value="IT3405"></td>  
                            <td>IT3405</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check5" value="IT3505"></td>  
                            <td>IT3505</td>

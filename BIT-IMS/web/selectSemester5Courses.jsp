<%-- 
    Document   : selectSemester5Courses
    Created on : Aug 3, 2016, 10:46:14 PM
    Author     : nadeesh
--%>
...
<html>
    <head>
        ...
        <title>Select Semester 5 Courses</title>
    </head>
    <body>
        <div class="container">
             <div class="col-sm-8">      
                <h1>Select Semester 5 Courses</h1>
                ...
                <form action="selectCoursesServlet" method="POST" name="selectSemester5Courses">
                    <table class="table table-striped tbl" border="1" style="width:100%">
                        ...
                        <tr>
                            <td><input type="checkbox" name="check1" value="IT5105"></td>  
                            <td>IT5105</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check2" value="IT5205"></td>  
                            <td>IT5205</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check3" value="IT5305"></td>  
                            <td>IT5305</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check4" value="IT5405"></td>  
                            <td>IT5405</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check5" value="EN5101"></td>  
                            <td>EN5101</td>

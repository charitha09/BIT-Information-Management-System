<%-- 
    Document   : selectSemester4Courses
    Created on : Aug 3, 2016, 10:46:01 PM
    Author     : nadeesh
--%>
...
<html>
    <head>
        ...
        <title>Select Semester 4 Courses</title>
    </head>
    <body>
        <div class="container"> 
            <div class="col-sm-8"> 
                <h1>Select Semester 4 Courses</h1>
                ...
                <form action="selectCoursesServlet" method="POST" name="selectSemester4Courses">
                    <table class="table table-striped tbl" border="1" style="width:100%">
                        ...
                        <tr>
                            <td><input type="checkbox" name="check1" value="IT4105"></td>  
                            <td>IT4105</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check2" value="IT4205"></td>  
                            <td>IT4205</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check3" value="IT4305"></td>  
                            <td>IT4305</td>
                        ...
                        <tr>
                            <td><input type="checkbox" name="check4" value="IT4405"></td>  
                            <td>IT4405</td>
                            <td>Data Communication & Networks I</td>
                            <td>Compulsory</td>
